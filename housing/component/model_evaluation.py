...
class ModelEvaluation:
    ...
    def get_best_model(self):
        try:
            model = None
            model_evalution_file_path = self.model_evaluation_config.model_evaluation_file_path
            ...
            model_eval_file_content = read_yaml_file(file_path=model_evalution_file_path)
    ...
    def update_evaluation_report(self, model_evaluation_artifact:ModelEvaluationArtifact):
        try:
            ...
            write_yaml_file(file_path=model_evalution_file_path, data=model_eval_file_content)      
